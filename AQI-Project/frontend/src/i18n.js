  ...
  en: {
    translation: {
      ...
      landing: {
        ...
        aiPowered: "AI-POWERED AIR QUALITY INTELLIGENCE",
        predictCleaner: "Predict Cleaner Journeys",
        beforeTravel: "Before You Travel",
        heroSub: "Know tomorrow's air quality today. AirAware combines AI, environmental intelligence, and route optimization to help you make healthier travel decisions.",
        getStarted: "Get Started",
        exploreProduct: "Explore Product",
        rollingForecast: "Rolling AI Forecast",
        lstmError: "LSTM Error Margin",
        spatialRes: "Spatial Resolution",
        engineActive: "AirAware Engine Active",
        livePrediction: "Live Prediction",
        h24Forecast: "24h Forecast",
        better37: "+37% Better",
        hyderabad: "Hyderabad",
        bengaluru: "Bengaluru",
        safeTravel: "Safe to Travel",
        optimalRoute: "Optimal route selected: 18% less exposure.",
        startRoute: "Start Route",
        hazardousZone: "HAZARDOUS ZONE",
        unhealthy: "UNHEALTHY",
        theReality: "THE REALITY",
        navigatingBlindly: "You are navigating blindly through toxic air.",
        millionsCommute: "Every day, millions commute through invisible pollution corridors. Without real-time environmental intelligence, you unknowingly expose yourself to severe respiratory and cardiovascular risks.",
        theShift: "THE SHIFT",
        currentAqiObsolete: "Current AQI is already obsolete.",
        knowingRightNow: "Knowing the air quality <em>right now</em> doesn't help if your commute is in two hours. AirAware uses machine learning to forecast pollution spikes, allowing you to plan ahead instead of reacting too late.",
        hourlyForecast: "Hourly Forecast",
        aiModelV2: "AI MODEL v2",
        hazardThreshold: "HAZARD THRESHOLD",
        intelligenceGlance: "Intelligence at a Glance",
        dashboardTransforms: "A real-time, interactive dashboard that transforms complex environmental data into actionable travel intelligence.",
        searchLocations: "🔍 Search locations...",
        overview: "📊 Overview",
        aqiMap: "🗺️ AQI Map",
        routePlanner: "🛣️ Route Planner",
        forecast: "📈 Forecast",
        aiPoweredShort: "AI Powered",
        healthScore: "Health Score",
        good: "Good",
        liveMap: "Live Map",
        suiteSubtitle: "AirAware isn't just an air quality monitor. It's a complete environmental intelligence suite.",
        interactiveMap: "Interactive Map",
        highResHeatmaps: "High-resolution pollution heatmaps for your city.",
        newDelhi: "New Delhi",
        aiForecast: "AI Forecast",
        tomorrowAqi: "Tomorrow: <strong>AQI 110</strong> 📈",
        hydBlrCleaner: "HYD → BLR <strong>18% Cleaner Route</strong>",
        moderateActivity: "Moderate Activity",
        maskRecommended: "😷 Mask Recommended",
        smartAlerts: "Smart Alerts",
        pushActive: "🔔 Push notifications active",
        aqiTrends: "AQI Trends",
        dashboard: "Dashboard",
        unifiedOverview: "Unified overview",
        cityHeatmaps: "City-wide heatmaps",
        healthierDirections: "Healthier directions",
        healthAlerts: "Health Alerts",
        personalizedNotifs: "Personalized notifications",
        readyCleaner: "Ready for cleaner air?",
        joinToday: "Join AirAware today and start making smarter, healthier decisions before you step outside.",
  ...
  hi: {
    translation: {
      ...
      landing: {
        ...
        // New landing page translations
        aiPowered: "एआई-संचालित वायु गुणवत्ता इंटेलिजेंस",
        predictCleaner: "स्वच्छ यात्राओं की भविष्यवाणी करें",
        beforeTravel: "यात्रा करने से पहले",
        heroSub: "आज ही कल की वायु गुणवत्ता जानें। एयरअवेयर एआई, पर्यावरण इंटेलिजेंस और रूट ऑप्टिमाइज़ेशन को जोड़कर आपको स्वस्थ यात्रा निर्णय लेने में मदद करता है।",
        getStarted: "शुरू करें",
        exploreProduct: "उत्पाद देखें",
        rollingForecast: "रोलिंग एआई पूर्वानुमान",
        lstmError: "LSTM त्रुटि मार्जिन",
        spatialRes: "स्थानिक रिज़ॉल्यूशन",
        engineActive: "एयरअवेयर इंजन सक्रिय",
        livePrediction: "लाइव भविष्यवाणी",
        h24Forecast: "24घंटे पूर्वानुमान",
        better37: "+37% बेहतर",
        hyderabad: "हैदराबाद",
        bengaluru: "बेंगलुरु",
        safeTravel: "यात्रा सुरक्षित है",
        optimalRoute: "इष्टतम मार्ग चुना गया: 18% कम एक्सपोज़र।",
        startRoute: "मार्ग शुरू करें",
        hazardousZone: "खतरनाक क्षेत्र",
        unhealthy: "अस्वस्थ",
        theReality: "वास्तविकता",
        navigatingBlindly: "आप विषैली हवा में अंधे होकर नेविगेट कर रहे हैं।",
        millionsCommute: "हर दिन, लाखों लोग अदृश्य प्रदूषण गलियारों से गुजरते हैं। रीयल-टाइम पर्यावरण इंटेलिजेंस के बिना, आप अनजाने में खुद को गंभीर श्वसन और हृदय जोखिमों के संपर्क में लाते हैं।",
        theShift: "परिवर्तन",
        currentAqiObsolete: "वर्तमान AQI पहले से ही अप्रचलित है।",
        knowingRightNow: "अभी वायु गुणवत्ता जानने से मदद नहीं मिलती अगर आपका आवागमन दो घंटे बाद है। एयरअवेयर मशीन लर्निंग का उपयोग करके प्रदूषण स्पाइक्स का पूर्वानुमान लगाता है, जिससे आप बहुत देर होने के बजाय पहले से योजना बना सकते हैं।",
        hourlyForecast: "घंटेवार पूर्वानुमान",
        aiModelV2: "एआई मॉडल v2",
        hazardThreshold: "खतरे की सीमा",
        intelligenceGlance: "एक नज़र में इंटेलिजेंस",
        dashboardTransforms: "एक रीयल-टाइम, इंटरैक्टिव डैशबोर्ड जो जटिल पर्यावरणीय डेटा को कार्रवाई योग्य यात्रा इंटेलिजेंस में बदल देता है।",
        searchLocations: "🔍 स्थान खोजें...",
        overview: "📊 अवलोकन",
        aqiMap: "🗺️ AQI मैप",
        routePlanner: "🛣️ रूट प्लानर",
        forecast: "📈 पूर्वानुमान",
        aiPoweredShort: "एआई संचालित",
        healthScore: "स्वास्थ्य स्कोर",
        good: "अच्छा",
        liveMap: "लाइव मैप",
        suiteSubtitle: "एयरअवेयर सिर्फ एक वायु गुणवत्ता मॉनिटर नहीं है। यह एक पूर्ण पर्यावरणीय इंटेलिजेंस सूट है।",
        interactiveMap: "इंटरैक्टिव मैप",
        highResHeatmaps: "आपके शहर के लिए हाई-रिज़ॉल्यूशन प्रदूषण हीटमैप।",
        newDelhi: "नई दिल्ली",
        aiForecast: "एआई पूर्वानुमान",
        tomorrowAqi: "कल: <strong>AQI 110</strong> 📈",
        hydBlrCleaner: "HYD → BLR <strong>18% स्वच्छ मार्ग</strong>",
        moderateActivity: "मध्यम गतिविधि",
        maskRecommended: "😷 मास्क की सिफारिश",
        smartAlerts: "स्मार्ट अलर्ट",
        pushActive: "🔔 पुश नोटिफिकेशन सक्रिय",
        aqiTrends: "AQI ट्रेंड्स",
        dashboard: "डैशबोर्ड",
        unifiedOverview: "एकीकृत अवलोकन",
        cityHeatmaps: "शहर-व्यापी हीटमैप",
        healthierDirections: "स्वस्थ दिशाएं",
        healthAlerts: "स्वास्थ्य अलर्ट",
        personalizedNotifs: "व्यक्तिगत सूचनाएं",
        readyCleaner: "स्वच्छ हवा के लिए तैयार?",
        joinToday: "आज ही एयरअवेयर से जुड़ें और बाहर निकलने से पहले होशियार, स्वस्थ निर्णय लेना शुरू करें।",
